...
const anyProduct: CatsForSale = {name: 'Mr. Fluff', kind: 'British Shorthair', age: 4, price: 50}
const productTitle = anyProduct.name
const priceWithTaxes = anyProduct.price * (1.25)
const upperCaseTitle = String(anyProduct.price).toUpperCase()
...
const someAccount: AccountOther = {
